...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Parameter.has_formula'
        db.delete_column(u'spoc_parameter', 'has_formula')

        # Adding field 'Parameter.formula_allowed'
        db.add_column(u'spoc_parameter', 'formula_allowed',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Parameter.has_formula'
        db.add_column(u'spoc_parameter', 'has_formula',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Deleting field 'Parameter.formula_allowed'
        db.delete_column(u'spoc_parameter', 'formula_allowed')
