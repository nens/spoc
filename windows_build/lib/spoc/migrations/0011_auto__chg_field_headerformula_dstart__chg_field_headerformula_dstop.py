...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'HeaderFormula.dstart'
        db.alter_column(u'spoc_headerformula', 'dstart', self.gf('django.db.models.fields.DateField')(null=True))

        # Changing field 'HeaderFormula.dstop'
        db.alter_column(u'spoc_headerformula', 'dstop', self.gf('django.db.models.fields.DateField')(null=True))

    def backwards(self, orm):

        # Changing field 'HeaderFormula.dstart'
        db.alter_column(u'spoc_headerformula', 'dstart', self.gf('django.db.models.fields.DateField')(auto_now_add=True, default=2))

        # Changing field 'HeaderFormula.dstop'
        db.alter_column(u'spoc_headerformula', 'dstop', self.gf('django.db.models.fields.DateField')(auto_now_add=True, null=True))
