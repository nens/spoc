...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Location.fews'
        db.add_column(u'spoc_location', 'fews',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Location.forward'
        db.add_column(u'spoc_location', 'forward',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Location.visible'
        db.add_column(u'spoc_location', 'visible',
    ...
    def backwards(self, orm):
        # Deleting field 'Location.fews'
        db.delete_column(u'spoc_location', 'fews')

        # Deleting field 'Location.forward'
        db.delete_column(u'spoc_location', 'forward')

        # Deleting field 'Location.visible'
        db.delete_column(u'spoc_location', 'visible')
