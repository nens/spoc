...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        # Changing field 'HeaderFormula.dstop'
        db.alter_column(u'spoc_headerformula', 'dstop', self.gf('django.db.models.fields.DateField')(auto_now_add=True, default=datetime.datetime(2014, 8, 26, 0, 0)))
    ...
    models = {
        ...
        u'spoc.headerformula': {
            ...
            'dstop': ('django.db.models.fields.DateField', [], {'auto_now_add': 'True', 'null': 'True', 'blank': 'True'}),
