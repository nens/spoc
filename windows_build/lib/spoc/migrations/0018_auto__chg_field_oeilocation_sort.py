...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'OEILocation.sort'
        db.alter_column(u'spoc_oeilocation', 'sort_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['spoc.LocationSort'], null=True))

    def backwards(self, orm):

        # Changing field 'OEILocation.sort'
        db.alter_column(u'spoc_oeilocation', 'sort_id', self.gf('django.db.models.fields.related.ForeignKey')(default=datetime.datetime(2014, 9, 11, 0, 0), to=orm['spoc.LocationSort']))
