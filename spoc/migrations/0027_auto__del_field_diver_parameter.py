...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Diver.parameter'
        db.delete_column(u'spoc_diver', 'parameter_id')


    def backwards(self, orm):
        # Adding field 'Diver.parameter'
        db.add_column(u'spoc_diver', 'parameter',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['spoc.Parameter']),
                      keep_default=False)
