...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'HeaderFormula.coef03'
        db.alter_column(u'spoc_headerformula', 'coef03', self.gf('django.db.models.fields.FloatField')(null=True))

        # Changing field 'HeaderFormula.coef01'
        db.alter_column(u'spoc_headerformula', 'coef01', self.gf('django.db.models.fields.FloatField')(null=True))

        # Changing field 'HeaderFormula.coef09'
        db.alter_column(u'spoc_headerformula', 'coef09', self.gf('django.db.models.fields.FloatField')(null=True))

        # Changing field 'HeaderFormula.coef08'
        db.alter_column(u'spoc_headerformula', 'coef08', self.gf('django.db.models.fields.FloatField')(null=True))

        # Changing field 'HeaderFormula.coef02'
        db.alter_column(u'spoc_headerformula', 'coef02', self.gf('django.db.models.fields.FloatField')(null=True))

        # Changing field 'HeaderFormula.coef05'
        db.alter_column(u'spoc_headerformula', 'coef05', self.gf('django.db.models.fields.FloatField')(null=True))

        # Changing field 'HeaderFormula.coef04'
        db.alter_column(u'spoc_headerformula', 'coef04', self.gf('django.db.models.fields.FloatField')(null=True))

        # Changing field 'HeaderFormula.coef07'
        db.alter_column(u'spoc_headerformula', 'coef07', self.gf('django.db.models.fields.FloatField')(null=True))

        # Changing field 'HeaderFormula.coef06'
        db.alter_column(u'spoc_headerformula', 'coef06', self.gf('django.db.models.fields.FloatField')(null=True))

        # Changing field 'HeaderFormula.coef12'
        db.alter_column(u'spoc_headerformula', 'coef12', self.gf('django.db.models.fields.FloatField')(null=True))

        # Changing field 'HeaderFormula.coef10'
        db.alter_column(u'spoc_headerformula', 'coef10', self.gf('django.db.models.fields.FloatField')(null=True))

        # Changing field 'HeaderFormula.coef11'
        db.alter_column(u'spoc_headerformula', 'coef11', self.gf('django.db.models.fields.FloatField')(null=True))

    def backwards(self, orm):

        # Changing field 'HeaderFormula.coef03'
        db.alter_column(u'spoc_headerformula', 'coef03', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=10, decimal_places=4))

        # Changing field 'HeaderFormula.coef01'
        db.alter_column(u'spoc_headerformula', 'coef01', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=10, decimal_places=4))

        # Changing field 'HeaderFormula.coef09'
        db.alter_column(u'spoc_headerformula', 'coef09', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=10, decimal_places=4))

        # Changing field 'HeaderFormula.coef08'
        db.alter_column(u'spoc_headerformula', 'coef08', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=10, decimal_places=4))

        # Changing field 'HeaderFormula.coef02'
        db.alter_column(u'spoc_headerformula', 'coef02', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=10, decimal_places=4))

        # Changing field 'HeaderFormula.coef05'
        db.alter_column(u'spoc_headerformula', 'coef05', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=10, decimal_places=4))

        # Changing field 'HeaderFormula.coef04'
        db.alter_column(u'spoc_headerformula', 'coef04', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=10, decimal_places=4))

        # Changing field 'HeaderFormula.coef07'
        db.alter_column(u'spoc_headerformula', 'coef07', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=10, decimal_places=4))

        # Changing field 'HeaderFormula.coef06'
        db.alter_column(u'spoc_headerformula', 'coef06', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=10, decimal_places=4))

        # Changing field 'HeaderFormula.coef12'
        db.alter_column(u'spoc_headerformula', 'coef12', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=10, decimal_places=4))

        # Changing field 'HeaderFormula.coef10'
        db.alter_column(u'spoc_headerformula', 'coef10', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=10, decimal_places=4))

        # Changing field 'HeaderFormula.coef11'
        db.alter_column(u'spoc_headerformula', 'coef11', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=10, decimal_places=4))
    ...
    models = {
        u'spoc.fews_oei_gemalen': {
            ...
            'OBJDERDEN': ('django.db.models.fields.CharField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'}),
        ...
        u'spoc.headerformula': {
            ...
            'coef01': ('django.db.models.fields.FloatField', [], {'null': 'True', 'blank': 'True'}),
            'coef02': ('django.db.models.fields.FloatField', [], {'null': 'True', 'blank': 'True'}),
            'coef03': ('django.db.models.fields.FloatField', [], {'null': 'True', 'blank': 'True'}),
            'coef04': ('django.db.models.fields.FloatField', [], {'null': 'True', 'blank': 'True'}),
            'coef05': ('django.db.models.fields.FloatField', [], {'null': 'True', 'blank': 'True'}),
            'coef06': ('django.db.models.fields.FloatField', [], {'null': 'True', 'blank': 'True'}),
            'coef07': ('django.db.models.fields.FloatField', [], {'null': 'True', 'blank': 'True'}),
            'coef08': ('django.db.models.fields.FloatField', [], {'null': 'True', 'blank': 'True'}),
            'coef09': ('django.db.models.fields.FloatField', [], {'null': 'True', 'blank': 'True'}),
            'coef10': ('django.db.models.fields.FloatField', [], {'null': 'True', 'blank': 'True'}),
            'coef11': ('django.db.models.fields.FloatField', [], {'null': 'True', 'blank': 'True'}),
            'coef12': ('django.db.models.fields.FloatField', [], {'null': 'True', 'blank': 'True'}),
        ...
        u'spoc.parameter': {
            ...
            'formula_allowed': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
