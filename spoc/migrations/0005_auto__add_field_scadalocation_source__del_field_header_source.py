...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ScadaLocation.source'
        db.add_column(u'spoc_scadalocation', 'source',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['spoc.Source'], null=True, blank=True),
                      keep_default=False)

        # Deleting field 'Header.source'
        db.delete_column(u'spoc_header', 'source_id')


    def backwards(self, orm):
        # Deleting field 'ScadaLocation.source'
        db.delete_column(u'spoc_scadalocation', 'source_id')

        # Adding field 'Header.source'
        db.add_column(u'spoc_header', 'source',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=datetime.datetime(2014, 8, 19, 0, 0), to=orm['spoc.Source']),
                      keep_default=False)
