...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'spoc_validation', 'value', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=14, decimal_places=6))

    def backwards(self, orm):

        # Changing field 'Validation.value'
        db.alter_column(u'spoc_validation', 'value', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=12, decimal_places=4))

    models = {
        u'spoc.diver': {
            'Meta': {'object_name': 'Diver'},
            'baro': ('django.db.models.fields.CharField', [], {'max_length': '10', 'null': 'True', 'blank': 'True'}),
            ...
            'ref_h': ('django.db.models.fields.FloatField', [], {'null': 'True', 'blank': 'True'})
        },
        ...
        u'spoc.validation': {
            ...
            'header': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['spoc.Header']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'value': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '12', 'decimal_places': '6', 'blank': 'True'})
        },
