...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Field.prefix'
        db.add_column(u'spoc_field', 'prefix',
                      self.gf('django.db.models.fields.CharField')(default='Z', max_length=1),
                      keep_default=False)

        # Adding unique constraint on 'Field', fields ['field_type', 'prefix']
        db.create_unique(u'spoc_field', ['field_type', 'prefix'])


    def backwards(self, orm):
        # Removing unique constraint on 'Field', fields ['field_type', 'prefix']
        db.delete_unique(u'spoc_field', ['field_type', 'prefix'])

        # Deleting field 'Field.prefix'
        db.delete_column(u'spoc_field', 'prefix')
