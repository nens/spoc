...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'OEILocation.y'
        db.delete_column(u'spoc_oeilocation', 'y')

        # Deleting field 'OEILocation.x'
        db.delete_column(u'spoc_oeilocation', 'x')


        # Changing field 'OEILocation.gpginzp'
        db.alter_column(u'spoc_oeilocation', 'gpginzp', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=10, decimal_places=4))

        # Changing field 'OEILocation.gpguitzp'
        db.alter_column(u'spoc_oeilocation', 'gpguitzp', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=10, decimal_places=4))

        # Changing field 'OEILocation.gpginwp'
        db.alter_column(u'spoc_oeilocation', 'gpginwp', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=10, decimal_places=4))

        # Changing field 'OEILocation.gpguitwp'
        db.alter_column(u'spoc_oeilocation', 'gpguitwp', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=10, decimal_places=4))

        # Changing field 'Validation.value'
        db.alter_column(u'spoc_validation', 'value', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=10, decimal_places=4))

        # Changing field 'HeaderFormula.coef1'
        db.alter_column(u'spoc_headerformula', 'coef1', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=10, decimal_places=4))

        # Changing field 'HeaderFormula.coef8'
        db.alter_column(u'spoc_headerformula', 'coef8', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=10, decimal_places=4))

        # Changing field 'HeaderFormula.coef4'
        db.alter_column(u'spoc_headerformula', 'coef4', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=10, decimal_places=4))

        # Changing field 'HeaderFormula.coef5'
        db.alter_column(u'spoc_headerformula', 'coef5', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=10, decimal_places=4))

        # Changing field 'HeaderFormula.coef6'
        db.alter_column(u'spoc_headerformula', 'coef6', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=10, decimal_places=4))

        # Changing field 'HeaderFormula.coef7'
        db.alter_column(u'spoc_headerformula', 'coef7', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=10, decimal_places=4))

        # Changing field 'HeaderFormula.coef2'
        db.alter_column(u'spoc_headerformula', 'coef2', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=10, decimal_places=4))

        # Changing field 'HeaderFormula.coef3'
        db.alter_column(u'spoc_headerformula', 'coef3', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=10, decimal_places=4))

    def backwards(self, orm):
        # Adding field 'OEILocation.y'
        db.add_column(u'spoc_oeilocation', 'y',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=19, decimal_places=2, blank=True),
                      keep_default=False)

        # Adding field 'OEILocation.x'
        db.add_column(u'spoc_oeilocation', 'x',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=19, decimal_places=3, blank=True),
                      keep_default=False)


        # Changing field 'OEILocation.gpginzp'
        db.alter_column(u'spoc_oeilocation', 'gpginzp', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=9, decimal_places=3))

        # Changing field 'OEILocation.gpguitzp'
        db.alter_column(u'spoc_oeilocation', 'gpguitzp', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=9, decimal_places=3))

        # Changing field 'OEILocation.gpginwp'
        db.alter_column(u'spoc_oeilocation', 'gpginwp', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=9, decimal_places=3))

        # Changing field 'OEILocation.gpguitwp'
        db.alter_column(u'spoc_oeilocation', 'gpguitwp', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=9, decimal_places=3))

        # Changing field 'Validation.value'
        db.alter_column(u'spoc_validation', 'value', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=9, decimal_places=3))

        # Changing field 'HeaderFormula.coef1'
        db.alter_column(u'spoc_headerformula', 'coef1', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=9, decimal_places=3))

        # Changing field 'HeaderFormula.coef8'
        db.alter_column(u'spoc_headerformula', 'coef8', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=9, decimal_places=3))

        # Changing field 'HeaderFormula.coef4'
        db.alter_column(u'spoc_headerformula', 'coef4', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=9, decimal_places=3))

        # Changing field 'HeaderFormula.coef5'
        db.alter_column(u'spoc_headerformula', 'coef5', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=9, decimal_places=3))

        # Changing field 'HeaderFormula.coef6'
        db.alter_column(u'spoc_headerformula', 'coef6', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=9, decimal_places=3))

        # Changing field 'HeaderFormula.coef7'
        db.alter_column(u'spoc_headerformula', 'coef7', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=9, decimal_places=3))

        # Changing field 'HeaderFormula.coef2'
        db.alter_column(u'spoc_headerformula', 'coef2', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=9, decimal_places=3))

        # Changing field 'HeaderFormula.coef3'
        db.alter_column(u'spoc_headerformula', 'coef3', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=9, decimal_places=3))
