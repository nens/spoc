...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Diver.header'
        db.add_column(u'spoc_diver', 'header',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['spoc.Header']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Diver.header'
        db.delete_column(u'spoc_diver', 'header_id')
