...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'OEILocation.created'
        db.delete_column(u'spoc_oeilocation', 'created')

        # Adding field 'Location.created'
        db.add_column(u'spoc_location', 'created',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2014, 8, 19, 0, 0), blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'OEILocation.created'
        db.add_column(u'spoc_oeilocation', 'created',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2014, 8, 19, 0, 0), blank=True),
                      keep_default=False)
