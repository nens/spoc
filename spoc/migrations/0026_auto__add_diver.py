...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'spoc_diver', (
            ...
            ('dstop', self.gf('django.db.models.fields.DateField')(null=True, blank=True)),
            ('ref_h', self.gf('django.db.models.fields.FloatField')(null=True, blank=True)),
            ('baro', self.gf('django.db.models.fields.CharField')(max_length=10, null=True, blank=True)),
        ))
        db.send_create_signal(u'spoc', ['Diver'])


    def backwards(self, orm):
        # Deleting model 'Diver'
        db.delete_table(u'spoc_diver')
