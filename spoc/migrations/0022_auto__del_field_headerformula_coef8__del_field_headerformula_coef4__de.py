...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'HeaderFormula.coef8'
        db.delete_column(u'spoc_headerformula', 'coef8')

        # Deleting field 'HeaderFormula.coef4'
        db.delete_column(u'spoc_headerformula', 'coef4')

        # Deleting field 'HeaderFormula.coef5'
        db.delete_column(u'spoc_headerformula', 'coef5')

        # Deleting field 'HeaderFormula.coef6'
        db.delete_column(u'spoc_headerformula', 'coef6')

        # Deleting field 'HeaderFormula.coef7'
        db.delete_column(u'spoc_headerformula', 'coef7')

        # Deleting field 'HeaderFormula.coef1'
        db.delete_column(u'spoc_headerformula', 'coef1')

        # Deleting field 'HeaderFormula.coef2'
        db.delete_column(u'spoc_headerformula', 'coef2')

        # Deleting field 'HeaderFormula.coef3'
        db.delete_column(u'spoc_headerformula', 'coef3')

        # Adding field 'HeaderFormula.coef01'
        db.add_column(u'spoc_headerformula', 'coef01',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=10, decimal_places=4, blank=True),
                      keep_default=False)

        # Adding field 'HeaderFormula.coef02'
        db.add_column(u'spoc_headerformula', 'coef02',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=10, decimal_places=4, blank=True),
                      keep_default=False)

        # Adding field 'HeaderFormula.coef03'
        db.add_column(u'spoc_headerformula', 'coef03',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=10, decimal_places=4, blank=True),
                      keep_default=False)

        # Adding field 'HeaderFormula.coef04'
        db.add_column(u'spoc_headerformula', 'coef04',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=10, decimal_places=4, blank=True),
                      keep_default=False)

        # Adding field 'HeaderFormula.coef05'
        db.add_column(u'spoc_headerformula', 'coef05',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=10, decimal_places=4, blank=True),
                      keep_default=False)

        # Adding field 'HeaderFormula.coef06'
        db.add_column(u'spoc_headerformula', 'coef06',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=10, decimal_places=4, blank=True),
                      keep_default=False)

        # Adding field 'HeaderFormula.coef07'
        db.add_column(u'spoc_headerformula', 'coef07',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=10, decimal_places=4, blank=True),
                      keep_default=False)

        # Adding field 'HeaderFormula.coef08'
        db.add_column(u'spoc_headerformula', 'coef08',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=10, decimal_places=4, blank=True),
                      keep_default=False)

        # Adding field 'HeaderFormula.coef09'
        db.add_column(u'spoc_headerformula', 'coef09',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=10, decimal_places=4, blank=True),
                      keep_default=False)

        # Adding field 'HeaderFormula.coef10'
        db.add_column(u'spoc_headerformula', 'coef10',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=10, decimal_places=4, blank=True),
                      keep_default=False)

        # Adding field 'HeaderFormula.coef11'
        db.add_column(u'spoc_headerformula', 'coef11',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=10, decimal_places=4, blank=True),
                      keep_default=False)

        # Adding field 'HeaderFormula.coef12'
        db.add_column(u'spoc_headerformula', 'coef12',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=10, decimal_places=4, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'HeaderFormula.coef8'
        db.add_column(u'spoc_headerformula', 'coef8',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=10, decimal_places=4, blank=True),
                      keep_default=False)

        # Adding field 'HeaderFormula.coef4'
        db.add_column(u'spoc_headerformula', 'coef4',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=10, decimal_places=4, blank=True),
                      keep_default=False)

        # Adding field 'HeaderFormula.coef5'
        db.add_column(u'spoc_headerformula', 'coef5',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=10, decimal_places=4, blank=True),
                      keep_default=False)

        # Adding field 'HeaderFormula.coef6'
        db.add_column(u'spoc_headerformula', 'coef6',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=10, decimal_places=4, blank=True),
                      keep_default=False)

        # Adding field 'HeaderFormula.coef7'
        db.add_column(u'spoc_headerformula', 'coef7',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=10, decimal_places=4, blank=True),
                      keep_default=False)

        # Adding field 'HeaderFormula.coef1'
        db.add_column(u'spoc_headerformula', 'coef1',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=10, decimal_places=4, blank=True),
                      keep_default=False)

        # Adding field 'HeaderFormula.coef2'
        db.add_column(u'spoc_headerformula', 'coef2',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=10, decimal_places=4, blank=True),
                      keep_default=False)

        # Adding field 'HeaderFormula.coef3'
        db.add_column(u'spoc_headerformula', 'coef3',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=10, decimal_places=4, blank=True),
                      keep_default=False)

        # Deleting field 'HeaderFormula.coef01'
        db.delete_column(u'spoc_headerformula', 'coef01')

        # Deleting field 'HeaderFormula.coef02'
        db.delete_column(u'spoc_headerformula', 'coef02')

        # Deleting field 'HeaderFormula.coef03'
        db.delete_column(u'spoc_headerformula', 'coef03')

        # Deleting field 'HeaderFormula.coef04'
        db.delete_column(u'spoc_headerformula', 'coef04')

        # Deleting field 'HeaderFormula.coef05'
        db.delete_column(u'spoc_headerformula', 'coef05')

        # Deleting field 'HeaderFormula.coef06'
        db.delete_column(u'spoc_headerformula', 'coef06')

        # Deleting field 'HeaderFormula.coef07'
        db.delete_column(u'spoc_headerformula', 'coef07')

        # Deleting field 'HeaderFormula.coef08'
        db.delete_column(u'spoc_headerformula', 'coef08')

        # Deleting field 'HeaderFormula.coef09'
        db.delete_column(u'spoc_headerformula', 'coef09')

        # Deleting field 'HeaderFormula.coef10'
        db.delete_column(u'spoc_headerformula', 'coef10')

        # Deleting field 'HeaderFormula.coef11'
        db.delete_column(u'spoc_headerformula', 'coef11')

        # Deleting field 'HeaderFormula.coef12'
        db.delete_column(u'spoc_headerformula', 'coef12')
    ...
    models = {
        ...
        u'spoc.headerformula': {
            ...
            'coef01': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '10', 'decimal_places': '4', 'blank': 'True'}),
            'coef02': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '10', 'decimal_places': '4', 'blank': 'True'}),
            'coef03': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '10', 'decimal_places': '4', 'blank': 'True'}),
            'coef04': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '10', 'decimal_places': '4', 'blank': 'True'}),
            'coef05': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '10', 'decimal_places': '4', 'blank': 'True'}),
            'coef06': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '10', 'decimal_places': '4', 'blank': 'True'}),
            'coef07': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '10', 'decimal_places': '4', 'blank': 'True'}),
            'coef08': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '10', 'decimal_places': '4', 'blank': 'True'}),
            'coef09': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '10', 'decimal_places': '4', 'blank': 'True'}),
            'coef10': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '10', 'decimal_places': '4', 'blank': 'True'}),
            'coef11': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '10', 'decimal_places': '4', 'blank': 'True'}),
            'coef12': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '10', 'decimal_places': '4', 'blank': 'True'}),
            ...
            'formula_type': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['spoc.FormulaType']"}),
