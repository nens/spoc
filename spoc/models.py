...
class HeaderFormula(models.Model):
    ...
    coef01 = models.FloatField(null=True, blank=True)
    coef02 = models.FloatField(null=True, blank=True)
    coef03 = models.FloatField(null=True, blank=True)
    coef04 = models.FloatField(null=True, blank=True)
    coef05 = models.FloatField(null=True, blank=True)
    coef06 = models.FloatField(null=True, blank=True)
    coef07 = models.FloatField(null=True, blank=True)
    coef08 = models.FloatField(null=True, blank=True)
